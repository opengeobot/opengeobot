<!--
Function: F-MEDIA-001 deployment summary — Media Object Upload, View & Retention deployment
Time: 2026-07-05
Author: AxeXie
-->

# F-MEDIA-001 Deployment Summary — Media Object Upload, View & Retention
...
- Migration: `V15__create_media_tables.sql` in apps/cloud-control/bootstrap/src/main/resources/db/migration/

## Deployment Steps
1. `docker compose -f deploy/compose/compose.yml --profile infra up -d`
2. `./scripts/dev.sh migrate` (Flyway applies migrations including V15__create_media_tables.sql)
