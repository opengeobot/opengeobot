<!--
Function: F-SAFETY-001 deployment summary — Action Safety, Emergency Stop & Reset deployment
Time: 2026-07-05
Author: AxeXie
-->

# F-SAFETY-001 Deployment Summary — Action Safety, Emergency Stop & Reset
...
- Migration: `V13__create_safety_tables.sql` in apps/cloud-control/bootstrap/src/main/resources/db/migration/

## Deployment Steps
1. `docker compose -f deploy/compose/compose.yml --profile infra up -d`
2. `./scripts/dev.sh migrate` (Flyway applies migrations including V13__create_safety_tables.sql)
