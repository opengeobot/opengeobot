<!--
Function: F-TRACE-001 deployment summary — Full-link Trace & Fact Replay deployment
Time: 2026-07-05
Author: AxeXie
-->

# F-TRACE-001 Deployment Summary — Full-link Trace & Fact Replay
...
- Migration: `V16__create_trace_tables.sql` in apps/cloud-control/bootstrap/src/main/resources/db/migration/

## Deployment Steps
1. `docker compose -f deploy/compose/compose.yml --profile infra up -d`
2. `./scripts/dev.sh migrate` (Flyway applies migrations including V16__create_trace_tables.sql)
