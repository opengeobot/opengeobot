<!--
Function: F-POLICY-001 deployment summary — Policy Version, Publish & Task Evaluation deployment
Time: 2026-07-05
Author: AxeXie
-->

# F-POLICY-001 Deployment Summary — Policy Version, Publish & Task Evaluation
...
- Migration: `V12__create_policy_tables.sql` in apps/cloud-control/bootstrap/src/main/resources/db/migration/

## Deployment Steps
1. `docker compose -f deploy/compose/compose.yml --profile infra up -d`
2. `./scripts/dev.sh migrate` (Flyway applies migrations including V12__create_policy_tables.sql)
