<!--
Function: F-MCP-001 deployment summary — MCP Tool Registry, Grayscale & Invocation deployment
Time: 2026-07-05
Author: AxeXie
-->

# F-MCP-001 Deployment Summary — MCP Tool Registry, Grayscale & Invocation
...
- Migration: `V10__create_mcp_tool_tables.sql` in apps/cloud-control/bootstrap/src/main/resources/db/migration/

## Deployment Steps
1. `docker compose -f deploy/compose/compose.yml --profile infra up -d`
2. `./scripts/dev.sh migrate` (Flyway applies migrations including V10__create_mcp_tool_tables.sql)
