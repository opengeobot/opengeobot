<!--
Function: F-EDGE-002 deployment summary — Local Execution, Offline Cache & Reconnection Reconciliation deployment
Time: 2026-07-05
Author: AxeXie
-->

# F-EDGE-002 Deployment Summary — Local Execution, Offline Cache & Reconnection Reconciliation
...
- Migration: `V11__create_mission_tables.sql` in apps/cloud-control/bootstrap/src/main/resources/db/migration/

## Deployment Steps
1. `docker compose -f deploy/compose/compose.yml --profile infra up -d`
2. `./scripts/dev.sh migrate` (Flyway applies migrations including V11__create_mission_tables.sql)
