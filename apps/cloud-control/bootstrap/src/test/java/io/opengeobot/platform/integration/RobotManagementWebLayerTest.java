/*
 * Function: Robot management web-layer tests - register, query, update, delete
 * Time: 2026-07-06
 * Author: AxeXie
 */
...
/**
 * Web-layer tests for the robot management flow. Tests the full CRUD cycle
...
@ActiveProfiles("test")
class RobotManagementWebLayerTest {
