/*
 * Function: Safety flow web-layer tests - emergency stop, reset, resume
 * Time: 2026-07-06
 * Author: AxeXie
 */
...
/**
 * Web-layer tests for the safety flow. Tests the SM-SAFETY-001 state machine
 * transitions through the REST API: emergency stop -> reset -> resume.
 */
@SpringBootTest
@AutoConfigureMockMvc
@ActiveProfiles("test")
class SafetyFlowWebLayerTest {
