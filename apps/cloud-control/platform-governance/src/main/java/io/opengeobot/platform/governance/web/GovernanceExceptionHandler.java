/*
 * Function: Governance exception handler — maps domain exceptions to ErrorEnvelope ProblemDetails
 * Time: 2026-07-04
 * Author: AxeXie
 */
...
/**
 * Translates governance-domain exceptions into the platform {@link ErrorEnvelope}
