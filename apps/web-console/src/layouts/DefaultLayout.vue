...
const navItems: NavItem[] = [
  ...
  { key: 'nav.robot_models', path: '/robot-models' },
  { key: 'nav.robot_groups', path: '/robot-groups' },
  { key: 'nav.edge_gateways', path: '/edge-gateways' },
  { key: 'nav.missions', path: '/missions' },
  { key: 'nav.mission_templates', path: '/mission-templates' },
  { key: 'nav.mission_approvals', path: '/mission-approvals', permission: 'mission.mission.read' },
  ...
  { key: 'nav.restricted_areas', path: '/restricted-areas' },
  { key: 'nav.monitor', path: '/monitor' },
  { key: 'nav.safety', path: '/safety', permission: 'safety.decision.read' },
  ...
  { key: 'nav.failure_cases', path: '/failure-cases', permission: 'memory.failure_case.read' },
  { key: 'nav.improvements', path: '/improvements', permission: 'memory.failure_case.read' },
